...
func (_m *StoreService) Merge(_a0 context.Context, _a1 *snapshot.Snapshot, _a2 []byte, _a3 []string) ([]byte, error) {
	ret := _m.Called(_a0, _a1, _a2, _a3)

	var r0 []byte
	if rf, ok := ret.Get(0).(func(context.Context, *snapshot.Snapshot, []byte, []string) []byte); ok {
	...
	var r1 error
	if rf, ok := ret.Get(1).(func(context.Context, *snapshot.Snapshot, []byte, []string) error); ok {
